package ru.tilman.styde.repository;

import ru.tilman.styde.JhipsterMssqlApp;
import ru.tilman.styde.config.Constants;
import ru.tilman.styde.config.audit.AuditEventConverter;
import ru.tilman.styde.domain.PersistentAuditEvent;
...
import static ru.tilman.styde.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
